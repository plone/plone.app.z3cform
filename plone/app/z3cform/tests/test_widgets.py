...
class IRelationsType(Interface):
    single = RelationChoice(title=u"Single", required=False, values=[])
    multiple = RelationList(title=u"Multiple (Relations field)", required=False)
...
class LinkWidgetIntegrationTests(unittest.TestCase):
    ...
    def test_link_widget__data_converter(self):
        ...
        self.assertEqual(
            converter.toWidgetValue(u"http://anyurl/resolveuid/1234")[
                "external"
            ],  # noqa
